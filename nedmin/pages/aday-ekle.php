...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-9">
            <h1 >Cum. Bşk. Adayı Ekleme Formu </h1>
     ...
     <div class="col-md-6">
        <div class="panel panel-default">
         ...
         <div class="panel-body">
            ...
            <div class="form-group">
                <div><img id="adayresim" src="../../dimg/noimage.png" width="150" height="130"></div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="cbaday_adsoyad"  placeholder="Aday Ad Soyadını Giriniz">
                <small  class="form-text text-muted">Adayın oylamada gözükecek adını ve soyadını giriniz...</small>
            </div>
